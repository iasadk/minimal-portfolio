...
const projectsData: Project[] = [
  {
    id: "proj_1",
    title: "Mentblue",
    description: `• Built and led the development of a secure legal mentorship platform, facilitating one-on-one and group sessions, courses, and webinars for law students and professionals.\n\n• Designed and implemented backend APIs and a robust admin panel to manage mentors, sessions, and content workflows.\n\n• Oversaw a team of developers to ensure high-performance, scalability, and secure user experience across interactions.`,
    type: "Web Platform",
    website: "https://mentblue.com",
    technologies: [
      "React (Next.js)",
      "TypeScript",
      "Node.js",
    ...
    created: "2024-12-01",
    updated: "2025-06-20",
    logoFileName: "mentblue.png",
  },
  {
    id: "proj_2",
    title: "Amouraa – Queer Dating App",
    description: `• Developed a cross-platform queer dating application available on both **iOS and Android**, designed to foster genuine connections in an inclusive and safe environment.\n\n• Built and maintained the **backend APIs** and a comprehensive **admin panel** for managing all app activities including user profiles, reports, content moderation, and analytics.\n\n• Implemented secure authentication, real-time chat with Socket.IO, and interest-based matching algorithms to ensure an engaging user experience.\n\n• Collaborated on delivering a clean, intuitive UI with smooth onboarding and optimized performance across devices.`,
    type: "Mobile Application",
    website: "https://play.google.com/store/apps/details?id=com.meet.social.amouraa", // add App Store / Play Store links if available
    technologies: [
      "SQL",
      "TypeScript",
      "Node.js",
      ...
      "Admin Panel (React + Tailwind + AntD)"
    ],
    status: "Published",
    featured: true,
    created: "2024-12-01",
    updated: "2025-06-20",
    logoFileName: "amouraa-logo.png",
  },
  {
    id: "proj_3",
    title: "Geni AI",
    description:
      `• Explore your PDF files without actually reading them. Upload it and ask question from AI about PDF.\n\n• Built a SaaS platform that leverages AI to provide instant answers from uploaded PDF documents, enhancing user productivity and information retrieval.\n\n• Developed a user-friendly interface for seamless PDF uploads and interactions, integrating advanced AI models for accurate and context-aware responses.`,
    type: "SaaS Platform",
    website: "https://geni-ai.vercel.app/",
    technologies: [
      "React (Next.js)",
      "TypeScript",
      "Node.js",
    ...
    created: "2023-06-01",
    updated: "2023-11-30",
    logoFileName: "geni-logo.svg",
  },
  {
    id: "proj_4",
    title: "E Waste Facility Locator",
    description: `• Developed a hackathon-winning web application to help users locate nearby e-waste recycling facilities using interactive maps and geolocation services.\n\n• Implemented features for users to search, filter, and get directions to registered facilities.\n\n• This project qualified our team for the **Smart India Hackathon (SIH)** and secured **2nd prize**, demonstrating its real-world impact and innovation.`,
    type: "Tool / Hackathon Project",
    website: "",
    github: "",
    technologies: [
      "React",
