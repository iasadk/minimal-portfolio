...
import { FaAws, FaCode, FaCss3Alt, FaDocker, FaGitAlt, FaHtml5, FaJava, FaProjectDiagram } from "react-icons/fa";
import { SiAdobephotoshop, SiAdobepremierepro, SiBootstrap, SiExpress, SiFirebase, SiGithubactions, SiGooglecloud, SiJavascript, SiJsonwebtokens, SiKnexdotjs, SiMongodb, SiMysql, SiNextdotjs, SiNodedotjs, SiOpenai, SiPostgresql, SiPostman, SiPrisma, SiPython, SiReact, SiTailwindcss, SiTypescript, SiWebauthn, SiWebpack } from "react-icons/si";
...
export const ALL_SKILLS: SkillData[] = [
  ...
  { name: "Kotlin", icon: <TbBrandKotlin  title="Kotlin" className="text-purple-500" />, category: "Programming Languages" },
  ...
  { name: "Django", icon: <DiDjango  title="Django" className="text-black dark:text-white" />, category: "Libraries & Frameworks" },
  { name: "Express.js", icon: <SiExpress title="Express.js" className="text-gray-700" />, category: "Libraries & Frameworks" },
  { name: "Knex.js", icon: <SiKnexdotjs title="Knex.js" className="text-orange-400" />, category: "Libraries & Frameworks" },
  ...
  { name: "Amazon web services", icon: <FaAws  title="Amazon web services" className="text-yellow-500" />, category: "Infrastructure & Tools" },
  ...
  { name: "Photoshop", icon: <SiAdobephotoshop title="Photoshop" className="text-blue-500" />, category: "Other" },
  { name: "Adobe Premier", icon: <SiAdobepremierepro  title="Adobe Premier" className="text-blue-800" />, category: "Other" },
];
